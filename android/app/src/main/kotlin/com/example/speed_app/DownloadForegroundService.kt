...
/**
 * 下载守护前台服务：下载期间让应用进程保持前台优先级，
 * 锁屏 / 深度休眠时网络不会被系统挂起。
 */
class DownloadForegroundService : Service() {
    companion object {
        const val SERVICE_NOTIFICATION_ID = 120001
        private const val CHANNEL_ID = "cloudreve_download_service"
        ...
        private fun buildNotification(
            ...
            launch?.putExtra("open_downloads", true)
