...
- **侧边栏**：「我的文件」目录树、与我共享、快速入口（图片/视频/音乐/文档，基于 Cloudreve v4 URI 搜索条件全局过滤，并在面包屑显示分类图标）、主题切换、管理站点、下载任务。
...
https://github.com/user-attachments/assets/159db441-d745-4716-a672-11234456742b
